...
const vi = {
  ...
  article: {
    ...
    breadcrumbShows: 'Trình diễn',
    backToShows: 'Xem tất cả show diễn',
    readMinutes: 'phút đọc',
    galleryTitle: 'Hình ảnh từ buổi diễn',
    videoTitle: 'Video recap',
    creditsTitle: 'Ê-kíp & địa điểm',
    notFoundTitle: 'Không tìm thấy bài viết',
    notFoundDesc: 'Đường dẫn có thể đã thay đổi hoặc bài viết chưa được đăng. Bạn có thể quay lại danh sách show diễn.',
    readFull: 'Chi tiết',
    readFullLong: 'Đọc bài viết đầy đủ',
  },
  partners: {
    title: 'Đối tác sân khấu, đại nhạc hội & thương hiệu đồng hành',
    logosCaption: 'Thương hiệu đã đồng hành cùng NCTA',
  },
  gear: {
...
const en: typeof vi = {
  ...
  article: {
    ...
    backToShows: 'See all shows',
    readMinutes: 'min read',
    galleryTitle: 'From the show',
    videoTitle: 'Recap video',
    creditsTitle: 'Credits & venue',
    notFoundTitle: 'Article not found',
    notFoundDesc: 'This link may have changed, or the article is not published yet. You can head back to the show list.',
    readFull: 'Details',
    readFullLong: 'Read the full story',
  },
  partners: {
    title: 'Stage, festival & brand partners',
    logosCaption: 'Brands that have worked with NCTA',
  },
  gear: {
